function insertDocs() {
  ...
  while (true) {
    print(
      "About to insert docs. So far, I have inserted " +
        docCount +
        " documents."
    );
    docs = [];
...
function currentOpKillOp() {
  ...
  x = db.currentOp();
  opDocs = [];
  x.inprog.forEach(function(opDoc) {
    print(
      "Found op: " +
        opDoc.op +
        " running for " +
  ...
  if (opDocs.length == 0) {
    ...
    print(
      "Didn't find a long running query. Are you sure you " +
    ...
    print(
      "I found two or more long running query operations. " +
    ...
    print("It has been running for " + opDoc.secs_running + " seconds.");
